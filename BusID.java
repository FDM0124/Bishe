...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
    ...
    private void init() {
        ...
        Button searchByID = (Button) findViewById(R.id.searchbyname);
        ...
        selectCity.setOnItemSelectedListener(this);//当listview item 被选择时调用。
        searchID = (EditText) findViewById(R.id.busName);
    ...
    public void searchLine() {
        ...
        //showProgressDialog();
        String search = searchID.getText().toString().trim();//trim()的作用是去掉字符串两端的多余的空格，注意，是两端的空格，且无论两端的空格有多少个都会去掉，
        ...
        busLineQuery = new BusLineQuery(search, SearchType.BY_LINE_ID,
...
*/
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position,
        ...
        //String cityString = itemCitys[position];
        cityCode=editText.getText().toString();
        //cityCode = cityString.substring(cityString.indexOf("-") + 1);//substring() 方法用于提取字符串中介于两个指定下标之间的字符。
    }
        ...
        busLineDialog.onListItemClicklistener(new OnListItemlistener() {
            ...
            public void onListItemClick(BusLineDialog dialog,
                ...
                busLineQuery = new BusLineQuery(lineId, SearchType.BY_LINE_ID,
                        "");// 第一个参数表示公交线路id，第二个参数表示公交线路id查询，第三个参数表示所在城市名或者城市区号
                BusLineSearch busLineSearch = new BusLineSearch(
                        BusID.this, busLineQuery);
                busLineSearch.setOnBusLineSearchListener(BusID.this);
    ...
    public void onBusLineSearched(BusLineResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            if (result != null && result.getQuery() != null
                ...
                ToastUtil.show(BusID.this, R.string.app_name);
            }
        } else {
            ToastUtil.showerror(BusID.this, rCode);
        }
    }
